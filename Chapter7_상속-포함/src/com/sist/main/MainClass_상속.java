 ...
 * 	  생성자: 메모리에 저장시 처음으로 호출되는 메소드(무조건 1개 이상을 포함함)
 * 	객체지향프로그램
 * 	-----------
 * 		데이터보호: 캡슐화
 * 		재사용: 상속, 포함
 ...
 * 		 ---------			----------
 * 			부모클래스, 상위 클래스 	    자식클래스, 하위 클래스
 * 		  2) 소스 코딩량이 적음 (상속으로 모든 내용을 저장했다고 가정) =상속을 받았다는 가정
 * 		  3) 코드를 공통적으로 관리하기 쉬움
 * 		  4) 재사용기법
 ...
 *			 	 } 	
 *
 *				*** 자바의 모든 클래스(사용자 정의 클래스, 라이브러리) -> Object 상속을 받고 있음 
 *					object를 최상위 클래스라고 함
 *					------ 복제, 소멸자, 문자열 변환, 비교
 *				*** 상속
 *					--- 있는 그대로 사용, 추가, 변경
