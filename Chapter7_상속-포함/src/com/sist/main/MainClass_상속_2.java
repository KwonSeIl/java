...
class Super2
{
	...
	// 생성자, 초기화블록, static -> 상속이 아니라 공유 
	//	------------> 상속 안됨
	//private은 상속이 됨(단 접근은 불가능 -> getter/setter)
}
class Sub2 extends Super2
{
	...
	/*
	 * 	==> 메모리상에만 저장이 됨 -> 메모리가 상속을 내린 클래스, 상속을 받은 클래스 => 따로 생성이 된다
	 * 	==> 단일 상속만 적용됨
	 * 	==> 상위 클래스가 하위클래스보다 데이터형이 크다
	 ...
	 *  	}
	 *  
	 *  	A a=new A();	a.a,a.b만 접근 가능
	 *  	***B b=new B();	b.a,b.b,b.c 접근 가능
	 ...
	 *  	A c=new B();
	 *  	double 	int
	 *  	B d=new A(); ==> 오류 발생 -> B d=(B)new A();로 변경해야 함
	 *  	int 	double				int a=(int)10.5;
	 *  	--------------------
	 *  int a;
		int b;
		public void display()
...
public class MainClass_상속_2 {
	...
	public static void main(String[] args) {
		...
		//System.out.println("sup.c="+sup.c); //접근 못함
