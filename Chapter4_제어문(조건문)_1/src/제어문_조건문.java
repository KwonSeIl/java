 ...
 * 			} 
 * 			점수를 입력받아 총점, 평균구하기 
 * 			kor ==> if(kor>=0 && kor<=100) ==> 처리가 어려운 부분 존재(예외처리-> 8장)
 * 			=> 항상 견고한 프로그램 
 * 			
 * 		2) 선택 조건문(가장 多사용) => 삼항연산자
 * 		 형식)
 * 		   if(조건) 
 * 		   {										
 * 			 조건 true일 때 수행하는 문장
 ...
 * 
 */
// 사용자로부터 정수 받아 홀수/짝수 확인
import java.util.Scanner; //여러개 사용 가능
...
public class 제어문_조건문 {
	...
	public static void main(String[] args) {
		...
		int num=scan.nextInt(); //정수값 가지고 오기: nextInt(), 문자열=>next(), 실수형=>nextDouble()
		// 논리=>nextBoolean()
		if(num%2==0)
