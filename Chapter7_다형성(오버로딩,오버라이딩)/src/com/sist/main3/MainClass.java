...
class Sub extends Super //Super 메모리 할당(생성자 호출=> 기본 생성자) -> Sub 메모리 할당
{
	int c;
	int a,b;
	public Sub(int a,int b,int c)
	{
		// 상위 클래스의 생성자를 먼저 호출해야 함
	...
	public void print()
	{
		...
		System.out.println("this.a="+a);// 본인 클래스의 객체 => this(this는 변수충돌이 없는 경우에 생략이 가능)
