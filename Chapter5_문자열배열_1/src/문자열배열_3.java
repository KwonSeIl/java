...
public class 문자열배열_3 {
	...
	public static void main(String[] args) {
        ...
        int curpage=1;
        //총페이지 ==> Math.ceil() : 올림 함수
        int totalpage=(int)(Math.ceil(title.length/10.0));
        // ceil: 올림 함수
        // 총 개수가 24개. 24/10=2 -> +1 -> 총 페이지 3. 10 10 4 보여줌
        //				24/10.0 => 2.4 -> 올림 => 3
        ...
        int rowSize=10;
        //인덱스의 시작위치
        int pagecnt=(curpage*rowSize)-rowSize; //인덱스의 시작 위치 .(curpage*10)-10 => 10개씩 보여줘라
        /*
         * 	0
         * 	...
         * 	9
        ...
        {
        	if(j<rowSize && i>=pagecnt) //페이지 나누기 . j=10개-> 나감 . 뒷부분은 skip->(19번까지 돌고 20페이지 수행)
        	{
