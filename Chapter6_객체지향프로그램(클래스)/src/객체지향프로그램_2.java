...
// 학생과 관련된 데이터를 모아서 저장 => 1명에 대한 정보를 설계함. => new 이용하면 여러명의 학생 정보를 저장할 수 있음 
// 클래스: 사용자가 직접 만들어 처리(크기 결정) 
class Student{
	int hakbun;
	String name;
	String sex;
...
public class 객체지향프로그램_2 {
	...
	public static void main(String[] args) {
		...
		hong.hakbun=1; //변수 => 필요시에는 언제든지 변경 가능 
		// . 연산자(메모리 주소 접근 연산자)
		hong.name="홍길동";
		hong.sex="남자";
		hong.age=25;
		...
		lee.hakbun=2; //변수 => 필요시에는 언제든지 변경 가능 
		lee.name="이순신";
		lee.sex="남자";
		lee.age=25;
		lee.kor=90;
		...
		kang.hakbun=3; //변수 => 필요시에는 언제든지 변경 가능 
		kang.name="강감찬";
		kang.sex="남자";
		kang.age=25;
		kang.kor=90;
